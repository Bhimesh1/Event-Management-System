		...
		<div class="col-md-6 contact-form">
			...
			<div class="col-md-6 contactright">
				...
				<div class="w3ls_footer_grid_left">
					...
					<p>Yogi Sabhagruha, Dadar, <span> Mumbai - 400014.</span></p>
				</div>
				<div class="w3ls_footer_grid_left">
					<div class="wthree_footer_grid_left">
				...
				<div class="w3ls_footer_grid_left">
					...
					<p><a href="mailto:info@example.com">bhimesh.patil@vsit.edu.in</a></p>
				</div>
			</div>
			...
			<div class="col-md-3 foot-left">
					...
					<p>you can get in touch with contanct and email both they are as give below</p>
						...
						<div class="contact-btm">
							...
							<p><a href="mailto:example@email.com">bhimeshpatil1@gmail.com</a></p>
						</div>
						<div class="clearfix"></div>
...
<!-- footer -->
			<div class="copy-right">
				...
				<div class="col-md-6 col-sm-6 col-xs-6 copy-right-grids">
						<div class="copy-left">
						<p> | Design by <a href="">Bhimesh</a></p>
						</div>
					</div>
